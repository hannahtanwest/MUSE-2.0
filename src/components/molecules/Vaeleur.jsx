...
import phoneMock from 'public/væleur-phone-mock.png'
    ...
    <div className={styles.container}>
        ...
        <div className={styles.displayTwo}>
            ...
            <div className={styles.igText}>
                ...
                <Link href="https://www.instagram.com/vaeleurstudio/" className={styles.igButton} target="_blank">INSTAGRAM</Link>
            </div>
        </div>

        <div className={styles.videoDisplay}>
        
            <div className={styles.vDisplay}>
                <video src={require('/public/v-video-one.mp4')} className={styles.hero} controls alt="SoMe video mockup"/>
            </div>
            <div className={styles.vDisplay}>
                <video src={require('/public/v-video-two.mp4')} className={styles.hero} controls alt="SoMe video mockup"/>
            </div>
            <div className={styles.vDisplay}>
                <video src={require('/public/v-video-three.mp4')} className={styles.hero} controls alt="SoMe video mockup"/>
            </div>
